...
class dbMySQL{
	...
	private $host = "gabrielcifuentes33266.ipagemysql.com" ;//your host
	private $user = "user_gmaps" ;//your user
	private $pass = "gmaps2544634";//your password
...
/*
 ...
 <?php 
$link = mysql_connect('gabrielcifuentes33266.ipagemysql.com', 'user_gmaps', '*password*'); 
if (!$link) { 
    die('Could not connect: ' . mysql_error()); 
} 
echo 'Connected successfully'; 
mysql_select_db(gmaps); 
?> 
*/
